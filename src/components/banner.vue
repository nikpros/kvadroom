    ...
    .banner
        .banner-nav
            ...
            .nav-menu
                ul.nav-menu-items
                    li.menu-item
                        a(href="" @click.prevent="selectItem(0)" :style="currentSlide === 0 ? currentActiveLinkStyle : ''") отделка
                    li.menu-item
                        a(href="" @click.prevent="selectItem(1)" :style="currentSlide === 1 ? currentActiveLinkStyle : ''") архитектура
                    li.menu-item
                        a(href="" @click.prevent="selectItem(2)" :style="currentSlide === 2 ? currentActiveLinkStyle : ''") планировки
        .banner-descr
            .text
        ...
        .banner-slider
            .banner-slider-view
                transition(name="fade" mode="out-in")
                    img(:src="currentImage" :key="currentSlide")
...
export default {
    ...
    computed: {
        ...
        currentActiveLinkStyle() {
            return {
                color: `hsl(${this.random}, 100%, 40%)`,
                'font-weight': 'bold'
            }
        }
    },
